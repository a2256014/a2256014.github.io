...
```
#### settings
>  권한, 훅, 환경 변수 같은 기술적 설정. CLAUDE.md와는 **별개 계층**이고, 이쪽은 명확한 **override(덮어쓰기)** 규칙
...
| 범위        | 위치                                                                                                                                                            |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 조직        | macOS: `/Library/Application Support/ClaudeCode/CLAUDE.md`  <br>Linux/WSL: `/etc/claude-code/CLAUDE.md`  <br>Windows: `C:\Program Files\ClaudeCode\CLAUDE.md` |
| **프로젝트**  | `./CLAUDE.md`                                                                                                                                                 |
