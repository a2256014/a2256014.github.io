...
BApp Store 설치
![](assets/images/posts/2026-05-14-AI/a6b98585cf00907ef9253504ac848fbe_MD5.jpeg)

![](assets/images/posts/2026-05-14-AI/8d187d820e15b97cfc6c34cf0b81df0f_MD5.jpeg)

[burp-mcp-all.jar](https://github.com/PortSwigger/mcp-server/releases/download/v1.3.0/burp-mcp-all.jar) 설치
...
"burp": {
            ...
            "args": [
                "-jar",
                "/Users/g3rm/.BurpSuite/mcp-proxy/mcp-proxy-all.jar",
                "--sse-url",
                "http://127.0.0.1:9876"
            ]
        }
in claude-code
claude mcp add burp -- <java경로> -jar /path/to/mcp-proxy-all.jar --sse-url http://127.0.0.1:9876/sse
```
