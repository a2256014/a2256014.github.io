...
```assembly
 ...
 <+5>:     mov    rbp,rsp
 <+8>:     sub    rsp,0x10
 <+12>:    mov    rax,QWORD PTR fs:0x28     fs[세그먼트]
 ...
 <+36>:    mov    rsi,rax
 <+39>:    mov    edi,0x0
 <+44>:    call   0x555555555070 <read@plt>
 <+49>:    mov    eax,0x0
 <+54>:    mov    rdx,QWORD PTR [rbp-0x8]
 <+58>:    sub    rdx,QWORD PTR fs:0x28
 <+67>:    je     0x5555555551b3 <main+74>
 <+69>:    call   0x555555555060 <__stack_chk_fail@plt>
 <+74>:    leave
 <+75>:    ret
```
### NX & ASLR
