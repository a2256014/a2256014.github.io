...
parser = argparse.ArgumentParser(description='ARM Exploit Script')
parser.add_argument('--bin', required=True, help='Path to the binary to execute')  # 필수 인자
parser.add_argument('-R', action='store_true', help='Remote?')  # 기본값 False
parser.add_argument('-D', action='store_true', help='Debug mode?')  # 기본값 False
parser.add_argument('-C', action='store_true', help='ARM target?')  # 기본값 False
